...
- A way to construct notion of "bad quality diamonds" without prior knowledge of this topic (as a happy consequence of previous point).
...
Also one interesting observation: most outliers are concentrated in the combination of "Fair" cut, "J" colour and "I1" clarity which are worst options among their features. This fact might be interpreted as __suggested combined outlier detection approach tagged really bad diamonds as outliers without prior knowledge about diamond quality__.
...
- Suggested "strong outlier" observations in `diamonds` dataset are not only those with extreme numerical values but also ones representing "bad quality" diamonds. This is achieved without prior knowledge of "diamond quality" notion.
